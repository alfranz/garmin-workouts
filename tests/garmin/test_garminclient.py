...
class GarminClientTestCase(unittest.TestCase):
    ...
    def test_list_workouts(self):
        ...
        self.httpserver.expect_request(url, query_string=params1).respond_with_json(
            any_workouts
        )
        self.httpserver.expect_request(url, query_string=params2).respond_with_json(
            empty_response
        )
    ...
    def test_list_workouts_error_handling(self):
        ...
        self.httpserver.expect_request(url, query_string=params).respond_with_data(
            status=500
        )
    ...
    def test_get_workout(self):
        ...
        self.httpserver.expect_request(url).respond_with_json(
    ...
    def test_get_workout_error_handling(self):
        ...
        with self.client as connection:
            self.assertRaises(
                requests.exceptions.HTTPError, connection.get_workout, workout_id
            )
    ...
    def test_save_workout(self):
        ...
        self.httpserver.expect_request(
            url, method="POST", json=GarminClientTestCase._ANY_WORKOUT
        ).respond_with_data()
    ...
    def test_update_workout(self):
        ...
        url = f"{GarminClient._WORKOUT_SERVICE_ENDPOINT}/workout/{workout_id}"
        self.httpserver.expect_request(
            url, method="PUT", json=GarminClientTestCase._ANY_WORKOUT
        ).respond_with_data()
    ...
    def test_delete_workout_error_handling(self):
        ...
        with self.client as connection:
            self.assertRaises(
                requests.exceptions.HTTPError, connection.delete_workout, workout_id
            )
    ...
    def test_schedule_workout(self):
        ...
        self.httpserver.expect_request(
            url, method="POST", json={"date": date}
        ).respond_with_data()
